...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AsyncCommit__ctor_mBC316513E94C120C9626641E149466A8D0FCD0CF (AsyncCommit_t71DC723123EBA5C843539A11885B9B64FBA2FF0D* __this, RuntimeObject* ___0_object, intptr_t ___1_method, const RuntimeMethod* method) 
{
	...
	if (MethodIsStatic((RuntimeMethod*)___1_method))
	{
		...
		if (isOpen)
			__this->___invoke_impl = (intptr_t)&AsyncCommit_Invoke_mAB6911D77D96EB8FAA0E2EE3FA1E3DCE323A528E_OpenStatic;
		else
			{
				__this->___invoke_impl = __this->___method_ptr;
				__this->___method_code = (intptr_t)__this->___m_target;
	...
	__this->___extra_arg = (intptr_t)&AsyncCommit_Invoke_mAB6911D77D96EB8FAA0E2EE3FA1E3DCE323A528E_Multicast;
}
